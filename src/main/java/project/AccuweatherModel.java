...
import static project.Period.FIVE_DAYS;
    ...
    public void getWeather(String selectedCity, Period period) throws IOException {
        switch (period) {
            ...
            case FIVE_DAYS:
                ...
                Response five_daysForecastResponse = okHttpClient.newCall(request5).execute();
                weatherResponse = five_daysForecastResponse.body().string();
                System.out.println(weatherResponse);
                //TODO: сделать человекочитаемый вывод погоды. Выбрать параметры для вывода на свое усмотрение
                //Например: Погода в городе Москва - 5 градусов по цельсию Expect showers late Monday night
                //dataBaseRepository.saveWeatherToDataBase(new Weather()) - тут после парсинга добавляем данные в БД
